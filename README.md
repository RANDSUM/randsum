...
- **[@randsum/dice-ui](packages/dice-ui)** - Web-only React UI components (notation input, roll visualizer) consumed by the docs site
...
- [Playground](https://randsum.io) - external legacy app, deployed outside this monorepo
