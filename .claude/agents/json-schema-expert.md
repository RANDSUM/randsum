...
`/packages/games/randsum.json` — this IS the JSON Schema (draft-2019-09) that validates all `.randsum.json` files.

The TypeScript types that mirror it live in `/packages/games/src/types.ts`.
