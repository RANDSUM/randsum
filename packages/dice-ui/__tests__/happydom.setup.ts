...
// the package-local bunfig.toml `[test] preload`. Pure-logic test files (e.g. notationBuilder,
// barrelParity) do not touch the DOM and are unaffected by its presence.
