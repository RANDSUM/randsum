  ...
  docs: [
    {
      ...
      examples: [
        { description: 'Roll 1d20, subtract 2', notation: '1d20-2', options: { sides: 20, modifiers: { minus: 2 } } },
        { description: 'Drop lowest, subtract 1', notation: '4d6L-1', options: { sides: 6, quantity: 4, modifiers: { drop: { lowest: 1 }, minus: 1 } } }
      ]
    }
  ]
})
