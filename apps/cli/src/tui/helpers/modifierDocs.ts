// SYNC: packages/component-library/src/components/ModifierReference/modifierDocs.ts
...
export const MODIFIER_DOCS: Readonly<Record<string, ModifierDoc>> = {
  ...
  '*': {
    ...
    examples: [
      { notation: '2d6*2+3', description: '(roll x 2) + 3' },
  ...
  '**': {
    ...
    examples: [
      { notation: '2d6+3**2', description: '(roll + 3) x 2' },
      { notation: '4d6L**3', description: '(drop-lowest sum) x 3' }
    ]
  },
  KL: {
    title: 'Keep Lowest',
