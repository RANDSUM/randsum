...
3. **Aliases inherit facets from their parent primitive.** An alias's Stage, Verb, and Channel are identical to the primitive it de-aliases to. Keep inherits Stage 1 / Filter / Pool from Drop. Minus inherits Stage 3 / Scale / Total from Plus.
