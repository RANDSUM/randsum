...
This is an alpha release. The specification is believed to be stable for implementation but may undergo minor revisions before the 1.0 release. Feedback is welcome via the [project repository](https://github.com/RANDSUM/randsum).
...
```abnf
;; ===================================================================
;; RANDSUM Dice Notation (RDN) v1.0-alpha
...
The following test vectors enable independent implementors to verify conformance with RDN v1.0-alpha. Each vector specifies a notation input, fixed dice values (the raw values the RNG would produce, in order), the expected pool after all modifiers, and the expected total.
...
| 38  | `5d6W`                   | [6, 3, 4, 2, 5]                                                                  | [6, 3, 4, 5]        | 18                 | 6.5.10  |
...
_End of RANDSUM Dice Notation Specification v1.0-alpha rev.1_
