...
const buildEmbed = (notationArg) => {
    ...
    if (!valid) {
        return new EmbedBuilder()
            ...
            .addFields({
            name: 'Learn More',
            value: 'See the [Dice Notation Guide](https://github.com/RANDSUM/randsum-ts/blob/main/RANDSUM_DICE_NOTATION.md) for more information.'
        })
...
export default async (interaction, { notation }) => {
