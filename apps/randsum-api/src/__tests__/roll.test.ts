...
describe('Roll Endpoint', () => {
  ...
  it('should handle basic roll with no parameters', async () => {
    ...
    const response = await handleRollRequest(request)
  ...
  it('should handle roll with individual parameters', async () => {
    const request = new Request('http://localhost:3000/roll?sides=8&quantity=3&plus=2')
    const response = await handleRollRequest(request)
    const data = await response.json()
  ...
  it('should handle roll with drop modifier', async () => {
    const request = new Request('http://localhost:3000/roll?sides=6&quantity=4&drop_lowest=1')
    const response = await handleRollRequest(request)
    const data = await response.json()
