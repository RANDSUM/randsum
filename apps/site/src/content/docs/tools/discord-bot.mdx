...
- **@randsum/blades** -- `/blades` for Blades in the Dark action rolls
- **@randsum/daggerheart** -- `/dh` for Daggerheart hope and fear dice
- **@randsum/root-rpg** -- `/root` for Root RPG mechanics
- **@randsum/salvageunion** -- `/su` for Salvage Union table rolls

For other systems (including D&D 5e and PbtA), use the `/roll` command with standard RANDSUM dice notation.
