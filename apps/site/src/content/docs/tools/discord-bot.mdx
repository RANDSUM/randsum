...
<LiveRepl readonly lang="bash" code={`/roll notation:4d6L+2
/roll notation:2d20H
/roll notation:3d8+5`} />
...
<LiveRepl readonly lang="bash" code={`/blades dice:3
/blades dice:2
...
<LiveRepl readonly lang="bash" code={`/dh modifier:5 rollingWith:Advantage
...
<LiveRepl readonly lang="bash" code={`/root modifier:2
/root modifier:-1
/root   # No modifier`} />
...
<LiveRepl readonly lang="bash" code={`/su table:Core Mechanic
/su table:Morale
...
<LiveRepl readonly lang="bash" code={`/notation`} />
...
<LiveRepl readonly lang="bash" code={`# From the monorepo root
cd apps/discord-bot
