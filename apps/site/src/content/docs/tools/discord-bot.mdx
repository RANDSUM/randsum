...
description: Add a dice rolling bot to your Discord server. Supports RANDSUM notation, D&D 5e, Blades in the Dark, Daggerheart, Fate Core, PbtA, and Root RPG with rich embeds.
---
