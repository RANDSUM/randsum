...
See the [Discord Bot landing page](/discord) for screenshots and quick setup.
...
![/roll notation:10d20 — rolled a 100](/discord-ss-roll-10d20.png)

![/dh modifier:3 — Daggerheart Critical Hope](/discord-ss-dh-critical.png)

![/roll notation:2d12+1 result](/discord-ss-roll-2d12.png)

![/su table:Core Mechanic — Salvage Union Failure](/discord-ss-su-failure.png)
