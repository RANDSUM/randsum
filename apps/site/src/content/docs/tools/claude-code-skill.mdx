---
title: Claude Skills
description: Three Claude Code skills that give AI agents dice rolling, probability analysis, and game spec authoring capabilities for any tabletop RPG system.
---
...
RANDSUM provides **three Claude Code skills** that give AI agents specialized knowledge for tabletop RPG dice mechanics.
