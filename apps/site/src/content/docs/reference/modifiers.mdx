...
<CodeExample readonly code={`interface ModifierOptions {
...
<CodeExample readonly code={`interface ComparisonOptions {
  greaterThan?: number
  lessThan?: number
}`} />
...
<CodeExample readonly code={`interface DropOptions extends ComparisonOptions {
  highest?: number
  lowest?: number
  exact?: number[]
}`} />
...
<CodeExample readonly code={`interface KeepOptions {
  highest?: number
  lowest?: number
}`} />
...
<CodeExample readonly code={`interface ReplaceOptions {
...
<CodeExample readonly code={`interface RerollOptions extends ComparisonOptions {
  exact?: number[]
  max?: number
}`} />
...
<CodeExample readonly code={`interface UniqueOptions {
  notUnique: number[]
}`} />
...
<CodeExample readonly code={`interface SuccessCountOptions {
  threshold: number
