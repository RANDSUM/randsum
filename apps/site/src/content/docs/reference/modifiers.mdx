...
<RollableCode client:only="react" liveArgs={['4d20C{>18}']} code={`roll('4d20C{>18}') // caps at 18`} />
...
<RollableCode client:only="react" liveArgs={['4d6L']} code={`roll('4d6L') // 3-18`} />
...
<RollableCode client:only="react" liveArgs={['4d6K3']} code={`roll('4d6K3') // 3-18`} />
...
<RollableCode client:only="react" liveArgs={['4d20R{<5}']} code={`roll('4d20R{<5}') // 4-20`} />
...
<RollableCode client:only="react" liveArgs={['4d20!']} code={`roll('4d20!') // 4+`} />
...
<RollableCode client:only="react" liveArgs={['4d20U']} code={`roll('4d20U') // 4-80`} />
...
<RollableCode client:only="react" liveArgs={['4d6+5']} code={`roll('4d6+5') // 9-29`} />

<RollableCode client:only="react" liveArgs={['2d8-2']} code={`roll('2d8-2') // 0-14`} />
...
<RollableCode client:only="react" liveArgs={['5d10S{7}']} code={`roll('5d10S{7}') // 0-5`} />
