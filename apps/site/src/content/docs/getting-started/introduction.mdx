---
title: Introduction to RANDSUM Dice Rolling Library
description: Learn how RANDSUM's zero-dependency dice engine works, why it never throws exceptions, and how game-specific packages simplify D&D, PbtA, Blades in the Dark, and more.
head:
  - tag: script
    attrs:
