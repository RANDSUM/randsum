...
| Property | Type | Description |
|---|---|---|
| `result` | `RollResult` | Hope/Fear/Critical Hope outcome |
| `total` | `number` | Sum of all dice + modifier |
| `details` | `RollDetails` | Detailed breakdown |
...
<CodeExample code={`import type { RollResult, RollDetails, GameRollResult, RollRecord } from '@randsum/games/daggerheart'
