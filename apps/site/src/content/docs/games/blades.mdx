...
description: TypeScript package for Blades in the Dark dice pools. Handles 0–6 dice, desperate position (0 dice), and returns critical, success, partial, or failure.
head:
  - tag: script
    attrs:
