...
<RollerPlayground defaultNotation="d%" client:only="react" />
...
<RollerPlayground defaultNotation="4dF" client:only="react" />
<RollerPlayground defaultNotation="dF.2" client:only="react" />
