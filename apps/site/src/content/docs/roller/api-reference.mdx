...
| Type | Description |
|---|---|
| `RollArgument<T>` | `RollOptions<T> \| DiceNotation \| ZeroBiasNotation \| CustomFacesNotation \| number` |
...
| `ZeroBiasNotation` | Branded string type for zero-bias notation (`zN`, `4z6`) |
| `CustomFacesNotation` | Branded string type for custom faces notation (`d{2,3,5,7}`, `d{fire,ice}`) |
