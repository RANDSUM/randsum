---
title: Modifiers
description: "Full TypeScript API for every RANDSUM modifier: cap, drop, keep, replace, reroll, explode, compound, penetrate, explode sequence, wild die, unique, count, sort, integer divide, modulo, and multipliers."
head:
  - tag: script
    attrs:
