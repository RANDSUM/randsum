...
<RollableCode client:only="react" code={`roll('1d20+5', '2d6+3') // combined total`} liveArgs={['1d20+5', '2d6+3']} />
...
<RollableCode client:only="react" code={`roll('2d12H') // 1-12 (drop highest — disadvantage)`} liveArgs={['2d12H']} />

<RollableCode client:only="react" code={`roll('2d12L') // 1-12 (drop lowest — advantage)`} liveArgs={['2d12L']} />
