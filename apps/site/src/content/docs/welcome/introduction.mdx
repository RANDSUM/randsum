...
- **`@randsum/games`** — game-specific roll functions for D&D 5e, Blades in the Dark, PbtA, and more
...
- **[Games — Getting Started](/games/getting-started/)** — roll with game-specific mechanics for D&D 5e, Blades, PbtA, and more
