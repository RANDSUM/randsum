...
<CardGrid>
  <Card title="@randsum/component-library" icon="puzzle">
    React component library providing interactive dice rolling UI elements. Depends on roller.
...
- **Bundle size enforced** -- roller 20KB (includes notation), game packages under 10KB each
