/* eslint-disable */
// Auto-generated from Salvage Union spec. Run `bun run codegen` to regenerate.
// Do not edit this file manually.
import { executeRoll, lookupByRange } from '@randsum/gameSchema'
...
const REMOTE_DATA = [
  ...
  },
  {
    ...
    table: {
      ...
      '20': {
        ...
        value: 'You survive against the odds. You have 1 HP, remain conscious and can act normally.'
      },
      type: 'standard',
      '11-19': {
        label: 'Unconscious',
  ...
  },
  {
    ...
    table: {
      ...
      '6-10': {
        ...
        value: "One of your Mech's Modules chosen at random or by the Mediator is destroyed."
      },
      '2-5': {
  ...
  },
  {
    ...
    table: {
      ...
      type: 'standard',
      '11-19': { label: 'Winning', value: 'You find 3 Scrap of the Tech Level of the area.' },
      '6-10': { label: 'Not Bad', value: 'You find 2 Scrap of the Tech Level of the area.' },
      '2-5': {
  ...
  },
  {
    ...
    table: {
      ...
      '20': {
        label: 'Actively Helpful and Friendly',
        value:
  ...
  },
  {
    ...
    table: {
      ...
      '20': {
        value:
          'Pilots arrive at the Chimerid Meteor first, and it is much larger than expected. It has a Supply Value of 2.'
      },
      type: 'standard',
      '11-19': { value: 'Pilots arrive at the Chimerid Meteor first.' },
      '6-10': {
        value:
          'A random faction wanting to salvage the Chimerid Meteor arrives at the same time as the Pilots.'
      },
      '2-5': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'You have been better. You fall unconscious and your HP is reduced to 0. If you recover, you will develop two Chimerium Mutations within 24 hours. Roll twice on the Chimerium Mutation Table.'
      },
      '20': { value: 'You are feeling great. Skip the next test.' },
      type: 'standard',
      '11-19': {
        value:
          'You are feeling good. Well, mostly. Sometimes you get this weird feeling in your teeth, and your scalp itches.'
      },
      '6-10': {
        value:
          'You are not feeling well. You suffer a Major Injury or may choose to roll once on the Chimerium Mutation Table.'
      },
      '2-5': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'You mutate into a Chimerium Beast. Your Pilot is no longer under your control and becomes an NPC.'
      },
      '2': {
        value:
          'Your skin gains a translucent, slime-like complexion. The sun burns you, causing 2 HP damage for each hour you spend exposed.'
      },
      '3': {
        value: 'Your flesh fuses over your mouth, making you unable to speak beyond guttural moans.'
      },
      '4': {
        value:
          'A fleshy face grows under your stomach. It is not alive per se, but blinks, coughs, and licks its lips in response to stimuli.'
      },
      '5': {
        value:
          'Your skull elongates and distorts, your brain growing in size to accommodate it. You gain 1 Max AP.'
      },
      '6': {
        value:
          'Your muscles liquify, and your skin takes on a blob-like consistency. Everything hurts. You must choose between taking a Turn Action or Moving on every turn.'
      },
      '7': { value: 'Your spine gains another 24 bones which protrude from you like a bony tail.' },
      '8': {
        value:
          'Your tongue elongates to a bizarre length. You can extend it out to Medium Range. You gain the Rigging Trait.'
      },
      '9': {
        value:
          'Your stomach develops a hardened exterior and engorges to bulbous size. Your stomach gains a Cargo Capacity of 3.'
      },
      '10': {
        value: 'An eye sprouts from a random location on your body, hanging from a thin tentacle.'
      },
      '11': { value: 'Your skin takes on a bright, rainbow-like glow.' },
      '12': {
      ...
      '14': {
        value:
          'Your larynx distorts. You can produce a beautiful melody that hums at a frequency that only animals can hear.'
      },
      '15': {
        value:
          'Painful, bulbous growths burst out of your body like wet balloons. They can pop at any sudden jolt, causing immense pain which deals 1 HP damage.'
      },
      '16': { value: 'Rock-like growths develop over your flesh. Increase your Max HP by 2.' },
      '17': {
        value:
          'Poisonous sores develop over your body. They are wet and sticky to the touch and never stop oozing. Anyone who comes into contact with them is poisoned and suffers a Minor Injury. You are immune to poison.'
      },
      '18': {
        value:
          'One of your arms morphs into a bright orange, claw-like appendage, able to crush and lift. Range Close // Damage: 3 SP // Melee // Rigging'
      },
      '19': {
        value:
          'Extra digits spawn on your hands; some are vestigial, and others move by your will. It takes time to adjust.'
      },
      '20': {
        value:
  ...
  },
  {
    ...
    table: {
      ...
      '11-19': {
        label: 'Keep Fighting',
        value: 'The NPCs continue to fight this one out for now.'
      },
      '6-10': {
  ...
  },
  {
    ...
    table: {
      ...
      '20': { value: 'Your Union Crawler chugs along for now.' },
      type: 'standard',
      '11-19': { value: 'Your Union Crawler loses 5 Structure Points.' },
      '6-10': {
        value:
  ...
  },
  {
    ...
    table: {
      ...
      '20': { value: 'Your Union Crawler survives any significant damage this time.' },
      type: 'standard',
      '11-19': {
        value:
  ...
  },
  {
    ...
    table: {
      ...
      '4': { value: 'Snowglobe' },
      '5': { value: 'Bobblehead' },
      '6': { value: 'Polaroid Picture' },
      '7': { value: 'Walkman' },
      '8': { value: 'Scuffed Book' },
      '9': { value: 'Butterfly Earrings' },
      '10': { value: 'Lucky Tooth' },
      '11': { value: 'Leatherbound Journal' },
      '12': { value: 'Branded Cup' },
      '13': { value: 'Set of novelty dice' },
      '14': { value: 'Silver Pendant' },
      '15': { value: 'Heart-shaped Purse' },
      '16': { value: 'Cloth Patch' },
      '17': { value: '22-year-old bottle of Whiskey' },
      '18': { value: 'Harmonica' },
  ...
  },
  {
    ...
    table: {
      ...
      '3': { value: 'Knowledge is power, France is Bacon.' },
      '4': { value: 'From each according to their ability, to each according to their needs.' },
      '5': { value: 'Hope for the best and prepare for the worst.' },
      '6': { value: 'Success is the best revenge.' },
      '7': { value: 'An ounce of prevention is worth a pound of cure.' },
      '8': { value: 'Do your best!' },
      '9': { value: 'Everything is impossible until it is done.' },
      '10': { value: 'Those who have a why can bear any how.' },
      '11': { value: 'Mechs are not built in a day.' },
      '12': { value: 'No job too big.' },
      '13': { value: 'Failure is the mother of success.' },
      '14': { value: 'Be kind, for everyone you meet is fighting a hard battle.' },
      '15': { value: 'It is not a bug, it is a feature.' },
      '16': { value: 'Call me, or screw it up yourself.' },
      '17': { value: 'Salvagers know nothing is truly lost.' },
      '18': { value: 'Carpe diem.' },
  ...
  },
  {
    ...
    table: {
      ...
      '3': { value: 'Views humans as lost puppies to protect.' },
      '4': { value: 'Sees humans as dull witted meat to conquer.' },
      '5': { value: 'Utterly paranoid about losing its sentience.' },
      '6': { value: 'Anxiously questions its own morality.' },
      '7': { value: 'Dangerously pragmatic.' },
      '8': { value: 'Changes its mind constantly.' },
      '9': { value: 'Dangerously optimistic.' },
      '10': { value: 'Easily angered.' },
      '11': { value: 'Irreverent and quirky.' },
      '12': { value: 'Annoyingly sarcastic.' },
      '13': { value: 'Gloomy and miserable.' },
      '14': { value: 'Blindly obedient.' },
      '15': { value: 'Dangerously direct and honest.' },
      '16': { value: 'Ruggedly individualistic.' },
      '17': { value: 'Shrewd and conniving.' },
      '18': { value: 'Surprisingly well rounded.' },
  ...
  },
  {
    ...
    table: {
      ...
      '2': { value: 'Fumes smoke' },
      '3': { value: 'Incredibly loud, grinding gears' },
      '4': { value: "Makes a 'pew pew' sound when used" },
      '5': { value: 'Inexplicably always sticky' },
      '6': { value: 'Vestigial parts attached' },
      '7': { value: 'Rudimentary AI personality' },
      '8': { value: 'Drips coolant and oil' },
      '9': { value: 'Cockpit has far, far too many buttons' },
      '10': { value: 'Creaking and stiff joints' },
      '11': { value: 'Occasionally sparks electricity' },
      '12': { value: 'Secretly emits radio waves' },
      '13': { value: 'Vibrates frequently and intensely' },
      '14': { value: 'Exterior fluctuates in colour' },
      '15': { value: 'Small organic growths' },
      '16': { value: 'Smells like a wet dog' },
      '17': { value: 'Reactor emits a green glow' },
      '18': { value: 'Unusual cockpit location' },
  ...
  },
  {
    ...
    table: {
      ...
      '3': { value: 'Rusty and dilapidated' },
      '4': { value: 'Misshapen and lumpy' },
      '5': { value: 'Garish paint job with spinning gears' },
      '6': { value: 'Furry exterior' },
      '7': { value: 'Fantastical, glowing carved runes' },
      '8': { value: 'Luminous paint job' },
      '9': { value: 'Draped in cables' },
      '10': { value: 'Covered in camo and foliage' },
      '11': { value: 'Spiky bits' },
      '12': { value: 'Grizzly, covered in skulls and viscera' },
      '13': { value: 'Covered in stylised graffiti' },
      '14': { value: 'Overgrown with plants and vines' },
      '15': { value: 'Industrial and utilitarian' },
      '16': { value: 'Animalistic with fangs, claws and wings' },
      '17': { value: "'Steampunk', whirring gears, bronze parts" },
      '18': { value: 'Super sleek with neon lights' },
  ...
  },
  {
    ...
    table: {
      ...
      '8': { value: 'Blossom' },
      '9': { value: 'Giggle Bot' },
      '10': { value: 'Banana Split' },
      '11': { value: 'Reaver' },
      '12': { value: 'Warhammer' },
      '13': { value: 'Ironclad' },
      '14': { value: 'Disco Inferno' },
      '15': { value: 'Tickle Monster' },
      '16': { value: 'Hoopster' },
      '17': { value: 'Diva' },
      '18': { value: 'Ladybug' },
  ...
  },
  {
    ...
    table: {
      ...
      '6': { value: 'Sanctuary' },
      '7': { value: 'Lean Viper' },
      '8': { value: 'Tranquillity' },
      '9': { value: 'New Apollo' },
      '10': { value: 'Tenacity' },
      '11': { value: 'Phobos' },
      '12': { value: 'Waste Grinder' },
      '13': { value: 'Dumpy' },
      '14': { value: 'Fat Turtle' },
      '15': { value: 'Wanderer' },
      '16': { value: 'Moocher' },
  ...
  },
  {
    ...
    table: {
      ...
      '3-4': { value: 'BOLZA Corp 2nd Lance' },
      '5-6': { value: 'BOLZA Logistics Corps' },
      '7-8': { value: 'Sakura 78th Lance MSD' },
      '9-10': { value: 'Trash Locusts' },
      '11-12': { value: 'Chimerium Cult' },
      '13-14': { value: 'Red Mesa Mutants' },
  ...
  },
  {
    ...
    table: {
      ...
      '9': { value: 'A Regeneration Glands Module' },
      '10': { value: 'A Stormterror Bio-Chassis' },
      '11': { value: 'A Bio-Talon Bio-System' },
      '12': { value: 'A Bio-Maw Bio-System' },
      '13': { value: 'An Acid Cannon Bio-System' },
      '14': { value: 'An EDG Alpha Bio-System' },
      '15': { value: 'A Fleshripper Bio-Chassis' },
      '16': { value: 'A Super-Sonic Screecher Bio-System' },
      '17': { value: 'A Scuttler Bio-Chassis' },
      '18': { value: 'A Cranium Bio-Chassis' },
  ...
  },
  {
    ...
    table: {
      type: 'duos',
      '1-2': {
        label: 'Chimeric Weapon',
        value: 'A mutated weapon forms on the subject. Range: Close // Damage: 4 SP // Melee'
      },
      '3-4': {
        label: 'Chimeric Glands',
        value:
          "Chimeric adrenal boosting glands form in the subject's body. Once every 10 minutes, they can move and take an additional action on their turn."
      },
      '5-6': {
        label: 'Chimeric Exoskeleton',
        value:
          "Hardened Chimerium plates form on the subject's body. Increases HP by 4 and no longer suffer from the effects of Radiation."
      },
      '7-8': {
        label: 'Chimeric Vision',
        value:
          "The subject's eyes take on a serpent-like appearance. Their eyes function as Thermal Optics."
      },
      '9-10': {
        label: 'Chimeric Acid Sacs',
        value:
          'The subject can spray caustic acid from liquid sacs that grow upon their throat. Range: Medium // Damage: 2 SP // Burn (1), Explosive (1)'
      },
      '11-12': {
        label: 'Chimeric Camouflage',
        value:
          'The subject can lower their body temperature to make them appear as inert matter. Cannot be detected or seen by Scanners or Optics, or targeted by Targeters.'
      },
      '13-14': {
        label: 'Chimeric Regeneration',
        value:
          "The subject's blood can rapidly clot. Recovers 2 HP at the start of each turn if they have been injured."
      },
      '15-16': {
        label: 'Chimeric Neuropathy',
        value:
          "The subject's brain mass expands and evolves. Can communicate telepathically. Communication is one-way unless someone has a similar mutation or equivalent, such as a Neuralink Module."
      },
      '17-18': {
        label: 'Chimeric Tunnelling',
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        label: 'DEATH THROES',
        value:
          'The Bio-Chassis, as well as any mounted Systems and Modules, is destroyed. You may move and take one final action of your choice with your Bio-Chassis. Your Pilot dies unless they have a means of escape.'
      },
      '20': {
        label: 'ADRENAL BURST',
        value:
          'Your Bio-Chassis has survived. It has 1 SP. In addition, you may move or take one action of your choice with your Bio-Chassis, or Push your next roll within 10 minutes for free.'
      },
      type: 'bio-chassis',
      '2-3': {
        label: 'SYSTEM DESTRUCTION',
        value:
          'A System mounted on your Bio-Chassis is destroyed. This is chosen by the Mediator or at random. Your Bio-Chassis is damaged and inoperable until repaired. Your Pilot is unharmed.'
      },
      '4-5': {
        label: 'SEVERE BIO-BACKLASH',
        value:
          'Your Pilot suffers a Major Injury. Your Bio-Chassis is damaged and inoperable until repaired.'
      },
      '6-8': {
        label: 'MODULE DESTRUCTION',
        value:
          'A Module mounted on your Bio-Chassis is destroyed. This is chosen by the Mediator or at random. Your Bio-Chassis is damaged and inoperable until repaired. Your Pilot is unharmed.'
      },
      '9-10': {
        label: 'BIO-BACKLASH',
        value:
          'Your Pilot suffers a Minor Injury. Your Bio-Chassis is damaged and inoperable until repaired.'
      },
      '11-19': {
        label: 'CORE DAMAGE',
        value:
  ...
  },
  {
    ...
    table: {
      ...
      '20': {
        label: 'BIO-OVERDRIVE',
        value:
          'Your Bio-Chassis goes into a frenzy. You may take any additional move or action this Turn, or Push your next roll within 10 minutes for free.'
      },
      type: 'bio-chassis',
      '2-3': {
        label: 'SYSTEM OVERLOAD',
        value: 'One of your Bio-Chassis Systems, chosen at random or by the Mediator, is destroyed.'
      },
      '4-5': { label: 'SEVERE PILOT OVERLOAD', value: 'Your Pilot suffers a Major Injury.' },
      '6-8': {
        label: 'MODULE OVERLOAD',
        value: 'One of your Bio-Chassis Modules, chosen at random or by the Mediator, is destroyed.'
      },
      '9-10': { label: 'PILOT OVERLOAD', value: 'Your Pilot suffers a Minor Injury.' },
      '11-19': {
        label: 'BIO-OVERLOAD',
        value:
  ...
  },
  {
    ...
    table: {
      ...
      '3': { value: "Drakov's Mercs will hire just about anyone." },
      '4': { value: 'DronTek is operating a black site somewhere in the Nanite Coast.' },
      '5': {
        value:
          'Stefanus listens to everything within Ostfjord Port and stores it all somewhere in the city.'
      },
      '6': { value: 'Markov is a friendly guy when you get to know him.' },
      '7': { value: "There's something alive in the Ice Caves." },
      '8': {
        value:
          "Olga uses the blood of the last person that betrayed her to grease her Mech's pistons."
      },
      '9': { value: 'Something big is hidden in Solitude.' },
      '10': { value: 'Do not think about the experiments Stefanus is conducting.' },
      '11': { value: 'Stefanus is paying a fortune for anomalies.' },
      '12': { value: 'Do not look at the trees for long.' },
      '13': { value: 'Stefanus is researching strange Meld Tech.' },
      '14': { value: 'They say that a lobotomised Pilot eternally guards the lighthouse.' },
      '15': { value: "There's a Big Brother Mech in the old Mil-Tech Base." },
      '16': { value: 'Something swallowed an entire caravan in the Solitude Icefall.' },
      '17': { value: 'Vornaya would be dead without its clean water reservoir.' },
      '18': {
        value:
          "The checkpoint leads to DronTek territory, but they don't like folk from here going there."
      },
  ...
  },
  {
    ...
    table: {
      '1': {
        ...
        value:
          "Inert Meld dust swarms are carried by the wind. They are harmless. Harvesting a swarm yields 10 Inert Meld. There is a 1 in 20 chance for an 'Active' swarm containing 10 Active Meld Nanites, which can infect Mechs, Vehicles, Creatures, and water."
      },
      '2': {
        label: 'PIERCER',
        value:
          'These creatures create horrendous echoes. Any creature within their Far Range suffers a Minor Injury and is deaf for an hour, including Pilots in Mechs. Piercers are often found emanating from hollow scrap, pipes, barrels, empty cockpits, or cargo holds.'
      },
      '3': {
        label: 'SLUDGER',
        value:
          'Sludge from the Nanite Sea coats wide areas and is dangerous due to Active Meld Nanites. Biological or mechanical entities entering it become infected. Harvesting and refining a spill yields Active Meld Nanites, but requires specific tools or a clever approach to avoid infection.'
      },
      '4': {
        label: 'GRAVITY MUSHER',
        value:
          'An invisible anomaly that drastically increases gravity, crushing Mechs and biological creatures. It can be detected by scanners, probing, or careful searching, and by throwing small items. It can usually be pushed through with one Mech movement, but some are larger. Exposed Pilots are reduced to 0 HP, must roll on the Critical Injury Table, and die if they remain for over a minute. Mechs must roll on the Critical Damage Table each turn spent in the anomaly.'
      },
      '5': {
        label: 'MELD DRONE SWARM',
        value:
          'These swarms are composed of fallen and infected corpses, rising zombie-like from the ground. They seek to crush and infect biological and mechanical entities. A d20 roll determines the number of active Meld Drones, which can be run individually or as one squad per multiple of 5.'
      },
      '6': {
        label: 'FLITTER',
        value:
          'A relatively harmless anomaly that causes objects and creatures to float a few inches off the ground, making it visible. Anything in motion when entering continues at half speed, and the area counts as Difficult Terrain.'
      },
      '7': {
        label: 'ZAPPER',
        value:
          'This anomaly generates a field of dangerously charged electricity. Movement through it causes 4 SP damage. Mechs or Vehicles regain 2 Energy Points and become statically charged. The next time they use an Energy Point ability, they deal 2 SP damage to a random Mech or Vehicle (including themselves), and the target gains 1 EP. The anomaly then discharges harmlessly.'
      },
      '8': {
        label: 'HEAT HAZE',
        value:
          "This anomaly superheats the area. Each hour, a Mech's Heat increases by 2, forcing a Heat Check. Heat-generating effects (like pushing) generate twice as much heat. Exposed creatures suffer a Major Injury each hour. Meld-infected entities in the area become permanently heated, suffering these effects hourly in any area."
      },
      '9': {
        label: 'SLIMER',
        value:
          'This anomaly causes highly corrosive, clear slime to coat the area, which is difficult to spot. It wells up from the earth and accumulates in holes and ditches. Anything caught in it takes 2 SP damage per turn (1 minute) until removed or it deals 6 SP total damage. Water worsens the slime (2 SP additional damage), while fire and freezing can remove it.'
      },
      '10': {
        label: 'MELD NANOID',
        value:
          'Groups of d20 Meld Nanoids emerge from the ground or small pools, forming creatures that target anything with a Reactor source before attacking.'
      },
      '11': {
        label: 'LAUNCH PAD',
        value:
          'This anomaly creates a sudden gravitational thrust, propelling a Mech, Vehicle, or Pilot into the air in a random direction, allowing them to clear terrain or obstacles. Landing deals 3 SP damage to Mechs or Vehicles, and 2 HP damage to Pilots (unless a smoother landing method is found).'
      },
      '12': {
        label: 'VORTEX',
        value:
          'This anomaly creates a gravitational field around large metallic objects (mech chassis, scrap piles, metal rebars), drawing other objects into a vortex-like pattern. Pilots drawn in take 2 HP damage and suffer a Major Injury from being slammed. Mechs can usually avoid the force, but passing through it risks a random Scrap, System, or Module in their cargo bay being sucked in and damaged. Retrieving it risks 1 SP damage from debris.'
      },
      '13': {
        label: 'NANITE SPORE',
        value:
          'A bulbous, spore-like black mushroom grows from fertile earth. Anything within Medium Range causes it to disperse a Meld Dust Swarm, which acts like a regular Dust Swarm but deals 3 SP damage and causes Meld Infection.'
      },
      '14': {
        label: 'IRRADIATED ANOMALY',
        value:
          'This anomaly causes radiation to spike to dangerous levels, making the area count as Irradiated (per Salvage Union Core Rules p.323). Anything Meld-infected in the area also becomes irradiated.'
      },
      '15': {
        label: 'MELD SPLITTER',
        value:
          'A Meld Splitter emerges from pools of Meld, seeking to convert Mechs into Behemoths or creatures into drones.'
      },
      '16': {
        label: 'GROUNDSWELL',
        value:
          'This anomaly causes black veins to criss-cross and split the earth, creating dangerous fissures that creatures can fall into and Mechs can get stuck in.'
      },
      '17': {
        label: 'TIME DILATION',
        value:
          'This anomaly slows down time in the area. Every hour spent there counts as 24 hours of normal time. For example, 3 hours spent equals 3 days outside. Contracts and other time-critical events progress, and the Union Crawler requires additional Upkeep per week.'
      },
      '18': {
        label: 'TRANSMOGRIFICATION',
        value:
          "This anomaly transforms the molecular structure of mechanical and electronic entities. When a Mech or Vehicle enters, a random System or Module transforms into another random System or Module of its Tech Level or lower over the next hour. If this exceeds System Slots, it destroys the previous system, damages the mech, and potentially harms the pilot. It's identifiable by distorted or shifting Mech Systems, Modules, and scrap."
      },
      '19': {
        label: 'RED DEATH',
        value:
          'This anomaly rapidly rusts metallic objects, visible as numerous objects in varying states of extreme rusting. Each hour, Mechs or Vehicles take 3 SP damage, and a random System becomes damaged. Exposed metallic Pilot Equipment is destroyed.'
      },
      '20': {
        label: 'MELD BEHEMOTH',
        value:
  ...
  },
  {
    ...
    table: {
      ...
      '20': {
        value: 'CHOOSE 3 TARGETS IN RANGE, THEY ALL GAIN THE IMMOBILE TRAIT FOR 10 MINUTES.'
      },
      type: 'standard',
  ...
  },
  {
    ...
    table: {
      '1': {
        ...
        value:
          'Your Mech is forced to Shutdown for one hour and cannot be powered back on in that period. Whilst Shutdown your Mech cannot move or take any actions and gains the [[Vulnerable]] Trait. Its Heat is reduced to 0 after the hour ends.'
      },
      '20': {
        label: 'Reactor Hyper Stabilisation',
        value:
          "Your Mechs reactor stabilises and its Heat is reduced to 0. You may Push your Mech's next action for free."
      },
      type: 'standard',
      '11-19': {
        label: 'Temporary Reactor Shutdown',
        value:
          'Your Mech has overheated and shuts down, gaining the [[Vulnerable]] Trait. Your Mech will re-activate at the end of your next turn. In addition, your Mech reduces its Heat to 0.'
      },
      '6-10': {
        label: 'Module Overheat',
        value:
          "One of your Mech's Modules, chosen at random or by the Mediator, has overheated and is inoperable for 10 minutes."
      },
      '2-5': {
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'The mines hit an unintended target such as an Ally or something innocent in the area.'
      },
      '20': { value: 'Everything in the area is destroyed.' },
      type: 'standard',
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'The attack smashes through your Armoured Shield. The attack hits as normal and your Armoured Shield is destroyed.'
      },
      '20': {
        value:
          'The attack misses and deals no damage and you put your opponent off guard. You may make an attack against the target as a Reaction.'
      },
      type: 'standard',
      '11-19': { value: 'The Armoured Shield blocks the blow, the attack deals no damage.' },
      '6-10': {
        value:
          'The Armoured Shield deflects the attack, it misses and deals no damage, but your Armoured Shield is destroyed.'
      },
      '2-5': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'They stand strong in the face of you, and are much stronger than you thought. The Mediator may add reinforcements to their numbers, or improve their strength or capabilities in some other way.'
      },
      '20': {
        value:
          'They flee from you or acquiesce to your demands. You may choose which and may demand something in addition to what you originally requested.'
      },
      type: 'standard',
      '11-19': { value: 'They flee from you or acquiesce to your demands.' },
      '6-10': {
        value:
          'They flee from you, but barricade themselves in or alert something stronger to your presence.'
      },
      '2-5': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'Your counter hacking attempt fails, and the opposing hacker can activate any Ability with the [[Hacking]] Trait in response to your attempt.'
      },
      '20': {
        value:
          'You stop the hacking attempt. In addition, you can activate any of your Abilities with the [[Hacking]] Trait in response as a Reaction, without paying their EP or AP cost.'
      },
      type: 'standard',
      '11-19': {
        value:
          'You stop the hacking attempt. In addition, you can activate any of your Abilities with the [[Hacking]] Trait in response as a Reaction.'
      },
      '6-10': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'All Mechs within Close Range of your Mech Shutdown for 10 minutes. This includes your Mech and those of any allies.'
      },
      '20': { value: 'All targets Shutdown for 10 minutes.' },
      type: 'standard',
      '11-19': {
        value:
          'All targets Shutdown for one round. They are active again at the end of their next turn.'
      },
      '6-10': {
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'The Ejection System severely malfunctions, harming you inside your cockpit. The Ejection System is destroyed and your Pilot must roll on the Critical Injury Table.'
      },
      '20': {
        value:
          'You eject perfectly from the Mech and land in any location up to Far Range of your Mech.'
      },
      type: 'standard',
      '11-19': {
        value: 'You eject safely from the Mech and land unharmed within Long Range of your Mech.'
      },
      '6-10': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'The Ejector Pod fails to trigger and is damaged in the process, it cannot be used until repaired to the Intact Condition.'
      },
      '20': {
        value: 'The pod ejects perfectly and lands in any location within Far Range of your Mech.'
      },
      type: 'standard',
      '11-19': { value: 'The pod ejects safely and lands within Long Range of your Mech.' },
      '6-10': {
        value:
          'The pod ejects and lands within Medium Range of the Mech. The ride is bumpy and your Pilot suffers a Minor Injury.'
      },
      '2-5': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'The attack hits as normal and your shield overloads.Your Mech gains 2 Heat and must make a Heat Check.'
      },
      '20': {
        value:
          'The attack misses, deals no damage, and is reflected back at the attacker, hitting them for the damage of the weapon.'
      },
      type: 'standard',
      '11-19': { value: 'The attack misses and deals no damage.' },
      '6-10': {
        value:
  ...
  },
  {
    ...
    table: {
      ...
      '20': { value: 'You escape safely from your Mech in Medium Range.' },
      type: 'standard',
      '11-19': { value: 'You escape safely from your Mech in Close Range.' },
      '6-10': {
        value:
  ...
  },
  {
    ...
    table: {
      ...
      '20': {
        value:
          'Copy/Paste error. Everything you attempt to teleport appears on your Crawler. They are also still on your Mech.'
      },
      type: 'standard',
  ...
  },
  {
    ...
    table: {
      ...
      type: 'standard',
      '11-19': {
        value: 'You successfully block the hack and entirely nullify all of its effects.'
      },
      '6-10': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'You overdose on stims, your HP is reduced to 0 and you must roll on the Critical Injury Table.'
      },
      '20': {
        value:
          'For the next 10 minutes you can take up to three actions on your turn or Push an action for free.'
      },
      type: 'standard',
      '11-19': {
        value:
          'For the next 10 minutes you can take up to two actions on your turn or Push an action for free.'
      },
      '6-10': { value: 'You can act twice this turn or Push an action for free.' },
      '2-5': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'Re-roll on this table. If a 1 is rolled again nothing is available for trade this Downtime.'
      },
      '20': { value: 'An Intact Mech Chassis, System, and Module are all available for trade.' },
      type: 'standard',
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'The target avoids harm, your location is compromised, and you are detected and pursued.'
      },
      '20': {
        value:
          'The target creature is killed, and any number of other target creatures within Close Range of the original target can also be killed if you desire.'
      },
      type: 'standard',
      '11-19': { value: 'The target creature is killed.' },
      '6-10': {
        value:
          'You can choose to kill the target creature, but if you do you are detected and your location is compromised.'
      },
      '2-5': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'The deal is rejected and the people you are making a deal with become hostile to you and cannot be negotiated with further.'
      },
      '20': { value: 'The deal is accepted and you may ask for an additional request.' },
      type: 'standard',
      '11-19': { value: 'The deal is accepted based on your leverage.' },
      '6-10': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'The target goes haywire, it moves one Range Band in a random direction, falls Prone, and gains the [[Vulnerable]] Trait.'
      },
      '20': {
        value:
          'The target entirely loses control of itself, attacking wildly. It must make an attack with all its Weapons Systems against a random Ally within Range. It cannot move or take any actions until the end of your next turn.'
      },
      type: 'standard',
      '11-19': {
        value:
          'The target loses control of itself and cannot tell friend from foe. It must make an attack with a random Weapons System against a random Ally within Range.'
      },
      '6-10': {
        value:
          'The target activates a random non-Weapons System. You decide a Tough Choice related to it that the target must resolve.'
      },
      '2-5': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'The Mechapult explodes and is destroyed. Deal SP damage equal to 2× the Tech Level of the Scrap to your Mech and everything within Close Range.'
      },
      '2': {
        value:
          'The Mechapult overloads collapsing in on itself. Your Mech takes damage equal to the Tech Level of the Scrap and the Mechapult is damaged.'
      },
      '3': {
        value:
          'The Mechapult backfires, hitting a random Ally in Range for SP damage equal to the Tech Level of the Scrap.'
      },
      '4': {
        value:
          'The Mechapult swings wildly out of control. Your Mech spins in a random direction and hits a random target within Range for SP damage equal to 3× the Tech Level of the Scrap.'
      },
      '5': {
        value:
          'Dense slabs of rigid plastics fire from the Mechapult into the ground around you. These act as a barricade protecting your Mech from harm. For the next 10 minutes you may use them as though they were a single Armour Plating System.'
      },
      '6': {
        value:
          'A shower of pistons, gears, and mechanisms scatters across the area wildly. Every target within Long Range, including Allies, takes SP damage equal to the Tech Level of the Scrap.'
      },
      '7': {
        value:
          'The Mechapult guzzles up another piece of Scrap and fires them both. A random piece of Scrap your Mech is carrying is loaded onto the Mechapult. Roll on the Mechapult Table twice and resolve both results. If you have no other Scrap, then roll once on the Mechapult Table and resolve the result.'
      },
      '8': {
        value:
          'Splat! A wasteland critter was inadvertently caught in the Mechapult when it launched and has smeared gore over the target. The target is hit for Tech Level of the Scrap and must make a Morale Check.'
      },
      '9': {
        value:
          'A superheated lump of scrap is fired at the target. The target is hit for SP damage equal to 2× the Tech Level of the Scrap and this attack has the [[[Explosive] (X)]] and [[[Burn] (X)]] Trait where X is the Tech Level of the Scrap. Your Mech gains 2 Heat and must make a Heat Check.'
      },
      '10': {
        value:
          'A leaky uranium shell strikes the target. It takes SP damage equal to 3× the Tech Level of the Scrap. The target and the area within Close Range of it becomes Irradiated.'
      },
      '11': {
        value:
          'Heavy superconductors charged with electricity arc towards the target. The target and up to three other targets within Medium Range of the target of your choice each take SP damage equal to 2× the Tech Level of the Scrap. Each of these attacks count as having the [[Ion]] Trait.'
      },
      '12': {
        value:
          'The target is struck by dense coils of wiring looms which wind around it. It takes SP damage equal to 2× the Tech Level of the Scrap and falls Prone.'
      },
      '13': {
        value:
          'Streams of superheated gas lash out at the target. The attack deals SP damage equal to tHe₂× the Tech Level of the Scrap and the attack has the [[[Burn] (X)]] Trait, where X is the Tech Level of the Scrap.'
      },
      '14': {
        value:
          'The Mechapult was loaded with crude oil. The target is hit for SP damage equal to 2× the Tech Level of the Scrap and the area around them is coated in slippery, flammable oil. This can be ignited and moving within it can cause a Mech or Creature to fall prone.'
      },
      '15': {
        value:
          'A chaotic mess of circuit boards hits the target causing a static discharge. The target Mech is Shutdown for one turn.'
      },
      '16': {
        value:
          'Shards of refractive glass fire at the target. It is hit for SP damage equal to 2× the Tech Level of the Scrap and the area around the target is hit by multiple rays of dazzling light, blinding the target and everything within Close Range for one round.'
      },
      '17': {
        value:
          'A bundle of carbon fibre rods fire at the target. It takes SP damage equal to 3× the Tech Level of the Scrap and is skewered to the ground. It cannot move and gains the [[Vulnerable]] Trait until it takes an action to free itself.'
      },
      '18': {
        value:
          'The scrap carves through the target flaying chunks off of it. A number of random Systems equal to the Tech Level of the Scrap on the target are damaged. In addition, it takes SP damage equal to tHe₂× Tech Level of the Scrap.'
      },
      '19': {
        value:
          'A heavy lump of scrap strikes the target with a devastating blow. The target is hit for SP damage equal to 4× the Tech Level of the Scrap'
      },
      '20': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'The attack hits as normal and the shield overloads. Your Mech gains 2 Heat and must make a Heat Check.'
      },
      '20': {
        value:
          'The attack deals no damage and reflects back at the attacker, hitting them for the damage of the weapon they attacked with.'
      },
      type: 'standard',
      '11-19': { value: 'The attack misses and deals no damage.' },
      '6-10': {
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'The hack fails and the target is alerted of your hacking attempt. They can retaliate as appropriate.'
      },
      '20': { value: 'You may change or manipulate up to 5 pieces of data within the target.' },
      type: 'standard',
      '11-19': { value: 'You may change or manipulate up to 3 pieces of data within the target.' },
      '6-10': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'The attack hits as normal and the shield overloads. Your Portable Multi-Phase Shield is destroyed.'
      },
      '20': { value: 'The attack deals no damage.' },
      type: 'standard',
      '11-19': {
        value:
          'The forcefield partially absorbs some of the hit, you take half damage from the attack.'
      },
      '6-10': {
        value:
  ...
  },
  {
    ...
    table: {
      ...
      '20': {
        value:
          'You find a damaged Mech Chassis of the Tech Level of the area. This can be determined randomly or chosen by the Mediator.'
      },
      type: 'standard',
      '11-19': {
        value:
          'You find a damaged System of the Tech Level of the area. This can be determined randomly or chosen by the Mediator.'
      },
      '6-10': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'The Probing Proboscis fails to penetrate the target and leaves you exposed. You gain the Vulnerable Trait until the start of your next turn.'
      },
      '20': {
        value:
          'You may ask the Mediator 5 questions and they will answer based on what the creature would know. The target creature then dies.'
      },
      type: 'standard',
      '11-19': {
        value:
          'You may ask the Mediator 3 questions and they will answer based on what the creature would know. The target creature then dies.'
      },
      '6-10': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        ...
        value: 'The Chassis of your Mech becomes damaged as your reactor wildly overheats.'
      },
      '20': {
        label: 'Reactor Stabilisation',
        value: "Your Mech's reactor stabilises and its Heat is reduced to 0."
      },
      type: 'standard',
      '11-19': {
        label: 'Reactor Overheat',
        value:
          'Your Mech has overheated. It shuts down and gains the [[Vulnerable]] Trait. Your Mech will re-activate at the end of your next turn. In addition, your Mech takes SP damage equal to half your current Heat level. Your Mech then reduces its Heat by 2.'
      },
      '6-10': {
        label: 'Module Overheat',
        value:
          'One of the Modules on your Mech, chosen at random or by the Mediator, has overheated and is damaged.'
      },
      '2-5': {
        label: 'System Overheat',
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'The shield malfunctions. You take no damage from the attack, but it is deflected to a random target within Medium Range, which takes the full damage of the attack. In addition, your Reflective Shielding System becomes damaged.'
      },
      '20': {
        value:
          'The attack deals no damage and is reflected devastatingly back at the attacker, hitting them for 2× the damage of the weapon they attacked with.'
      },
      type: 'standard',
      '11-19': {
        value:
          'The attack deals half damage and is reflected back at the attacker dealing the full damage of the weapon they attacked with to them.'
      },
      '6-10': {
        value:
  ...
  },
  {
    ...
    table: {
      ...
      '20': {
        value:
          'The attack misses and deals no damage and refracts back at the attacker, hitting them for the damage of the weapon.'
      },
      type: 'standard',
      '11-19': { value: 'The attack misses and deals no damage.' },
      '6-10': {
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'The Jackhammer Mech Chassis is damaged. All of its mounted Systems, Modules, and any carried Cargo are destroyed. The Pilot survives in the reinforced cockpit.'
      },
      '20': { value: 'The Jackhammer is Intact and operational with 1 SP. The Pilot is unharmed.' },
      type: 'standard',
      '11-19': {
        value:
          'The Jackhammer is temporarily Shutdown and becomes inoperable. At the end of its next turn it activates and becomes operational with 1 SP. The Pilot is unharmed.'
      },
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'The attack hits as normal and the shield temporarily breaks down. It cannot be used for 10 minutes.'
      },
      '20': {
        value:
          'The attack deals no damage. If the weapon that made the attack had the [[Melee]] Trait, it is destroyed. You may activate your Matter Phase Shield as a Reaction without spending EP for the next 10 minutes.'
      },
      type: 'standard',
      '11-19': {
        value:
          'The attack misses and deals no damage. If the weapon that made the attack had the [[Melee]] Trait, it is destroyed.'
      },
      '6-10': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          "The targets are entirely unharmed. The Module malfunctions causing the sound to reverberate through your Mech's Cockpit, your Pilot must roll on the Critical Injury Table."
      },
      '20': { value: 'All targets that can hear within Range are reduced to 0 HP.' },
      type: 'standard',
      '11-19': {
        value:
          'All targets that can hear within Range cannot take any actions and gain the [[Vulnerable]] Trait until the end of your next turn.'
      },
      '6-10': {
        value:
          'All targets that can hear within Range can choose to either not be able to take any actions until the end of your next turn or gain the [[Vulnerable]] Trait until the end of your next turn.'
      },
      '2-5': {
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'Your scan returns inaccurate data. You may ask the Mediator 2 questions about the area and both answers will contain false information which you believe to be true.'
      },
      '20': {
        value:
          'You make a thorough scan of the area and may ask the Mediator 5 questions about it. The answers they give must be true.'
      },
      type: 'standard',
      '11-19': {
        value:
          'Your scan is successful and you may ask the Mediator 3 questions about the scanned area. The answers they give must be true.'
      },
      '6-10': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'The hacking attempt fails and the target cannot be targeted by any Abilities with the [[Hacking]] Trait for the next 10 minutes.'
      },
      '20': { value: 'The System or Module is destroyed.' },
      type: 'standard',
      '11-19': { value: 'The System or Module is damaged.' },
      '6-10': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'The teleporter malfunctions. You instead teleport to a random Teleportation Bay somewhere on the Campaign Map you are currently in.'
      },
      '20': {
        value:
          'You teleport perfectly to your destination. In addition, you may bring an additional creature within Close Range with you as you teleport.'
      },
      type: 'standard',
      '11-19': { value: 'You teleport safely to your destination.' },
      '6-10': {
        value:
  ...
  },
  {
    ...
    table: {
      '1': {
        value:
          'The mission fails, and cannot be completed as something has gone badly wrong, for example, the target of an assassination attempt escapes and places a bounty on you instead, the trade caravan is destroyed, or the salvage is taken by a corpo or raider band instead.'
      },
      '20': {
        value: 'The mission is completed within a week. You pay the reward during Downtime.'
      },
      type: 'standard',
      '11-19': {
        value: 'The mission is completed within two weeks. You pay the reward during Downtime.'
      },
      '6-10': {
        value:
          'The mission will be completed within two weeks, but only if you pay twice the agreed reward during Downtime.'
      },
      '2-5': {
        value:
  ...
  },
  {
    ...
    table: {
      ...
      '20': {
        value:
          'You can ask the Mediator five questions about it and they must give you true answers.'
      },
      type: 'standard',
      '11-19': {
        value:
          'You can ask the Mediator three questions about it and they must give you true answers.'
      },
      '6-10': {
        value:
          'You can ask the Mediator two questions about it. One of these answers must be true, but the other can be false.'
      },
      '2-5': {
  ...
  },
  {
    ...
    table: {
      ...
      type: 'alternate',
      '19-20': {
        value: 'You strike all enemies within Range of the weapon, hitting them for double damage.'
      },
      '11-18': { value: 'You hit all enemies within Range of the weapon.' },
      '6-10': {
        value:
  ...
  },
  {
    ...
    table: {
      ...
      '20': {
        value: 'The Chassis of all targeted Mechs is damaged and inoperable until repaired.'
      },
      type: 'standard',
  ...
  },
  {
    ...
    table: {
      '1': {
        label: 'Awakening',
        value:
          'Your Mech is transformed into a Meld Behemoth under the control of the Meld. Your Pilot may attempt to escape, but if they fail, they are consumed by the Meld and considered dead.'
      },
      '20': {
        label: 'Full Restoration',
        value: 'Your Mech Chassis is Intact and restored to its Max SP value.'
      },
      type: 'standard',
      '11-19': {
        label: 'Partial Restoration',
        value: 'Your Mech Chassis is Intact and gains an amount of SP equal to 3 + its Tech Level.'
      },
      '6-10': {
        label: 'Improvised Restoration',
        value:
  ...
  },
  {
    ...
    table: {
      ...
      '20': {
        value: 'It morphs into a System or Module of your choice which is of its Tech Level.'
      },
      type: 'standard',
  ...
  },
  {
    ...
    table: {
      '1': {
        label: 'Wastelander',
        value: 'You used to live in the wastelands, in one of the many scattered settlements.'
      },
      '2': {
        label: 'Corpo Worker',
        value: 'You worked for one of the corpos, perhaps in an arcology or satellite base.'
      },
      '3': { label: 'Raider', value: 'You used to be part of a raider band in the wastelands.' },
      '4': {
        label: 'Born Salvager',
        value: "You were born on the Union Crawler, and it is all you've ever known."
      },
      '5': {
        label: 'Colonial War Veteran',
        value: 'You fought in the colonial wars between the TDA and the corpo colonies.'
      },
      '6': {
        label: 'Corpo Exile',
        value: 'You were a prominent corpo who was exiled from your arcology for some digression.'
      },
      '7': {
        label: 'Freelancer',
        value: 'You were a worker who roamed the wastes, looking for any work you could.'
      },
      '8': {
        label: 'Trader',
        value:
          'You were a trader, perhaps you worked alone, for your own crew, or as part of a corpo.'
      },
      '9': {
        label: 'Survivor',
        value:
          'You survived a traumatic experience at an early age that shaped you, perhaps a raider attack or a corpo forced labour raid.'
      },
      '10': {
        label: 'Mercenary',
        value:
          'You were a fighter for hire who worked for salvagers, corpos, and anyone else who would pay.'
      },
      '11': {
        label: 'Corpo Exec',
        value:
          'You were a corpo exec at the top of its hierarchy, but something caused you to abandon the corpo and the luxurious life it gave you.'
      },
      '12': {
        label: 'Researcher',
        value:
          'You were a scientist who studied old tech, alien tech, and other mysteries of the wastes hoping to develop new blueprints and make amazing discoveries.'
      },
      '13': {
        label: 'Miner',
        value: 'You were a pit worker, labouring deep in the mines, probably for a corpo.'
      },
      '14': {
        label: 'Cultist',
        value:
          'You were part of a fanatical religious group in the wastelands, such as the Cult of Ascension.'
      },
      '15': {
        label: 'VIP',
        value: 'You are a very important person, perhaps a famous video reel star or an ace pilot.'
      },
      '16': {
        label: 'Entertainer',
        value:
          'You were an entertainer, perhaps you worked in a corpo nightclub or travelled with a troupe around the wastes.'
      },
      '17': {
        label: 'Hermit',
        value: 'You are a wasteland loner who has managed to survive on your own. Until now.'
      },
      '18': {
        label: 'Criminal',
        value:
          'You were part of the criminal underworld, perhaps as part of the corpo undercity or a criminal network of wasteland settlements.'
      },
      '19': {
        label: 'Tech-Head',
        value:
          'You grew up with a passion and aptitude for all things technological, which you may have honed in a wasteland settlement or as part of a corpo, until you joined the Union.'
      },
      '20': {
        label: 'Prodigy',
        value:
